...
#define FLASH_ALL_END         ((uint32_t)0x0005FFFFU)

// use last sector to emulate eeprom
#define FLASH_EEPROM_BASE     ((uint32_t)0x0005E000U)


#define FLASH_BASE            ((uint32_t)0x0005E000U)              /*!< FLASH base address in the alias region */
...
// power outage
#define FLASH_OUTAGE_DATA_ADDR  ((uint32_t)0x0005C000U)
