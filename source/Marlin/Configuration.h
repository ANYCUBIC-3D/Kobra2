...
/**
 * --NORMAL IS 4.7k�� PULLUP!-- 1k�� pullup can be used on hotend sensor, using correct resistor and table
 *
 ...
 *
 *  Analog Thermistors - 1k�� pullup - Atypical, and requires changing out the 4.7k�� pullup for 1k��.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  18.00//22.20
    #define DEFAULT_Ki   1.01//1.08
    #define DEFAULT_Kd  63//119.00
  #endif
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 463.09 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 16, 80 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 800, 5000 }
...
#define AUTO_BED_LEVELING_BILINEAR  // detele by kevin
