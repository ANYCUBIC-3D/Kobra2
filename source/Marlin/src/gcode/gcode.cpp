  ...
  */
  ...
  switch (parser.command_letter) {
    ...
    case 'M': switch (parser.codenum) {
      ...
      #if HAS_EXTRUDERS
        case 104:{if(printingIsActive()) M109();else M104();break;}                                 // M104: Set hot end temperature
      ...
      #if HAS_HEATED_BED
        case 140: {if(printingIsActive()) M190();else M190();break;}                                // M140: Set bed temperature
