...
#define PAGE_CHS_LEVEING                     		(216+PAGE_OFFSET)
#define PAGE_CHS_LEVEING_DARK                   (217+PAGE_OFFSET)
#define PAGE_ENG_LEVEING                    		(218+PAGE_OFFSET) 
#define PAGE_ENG_LEVEING_DARK                   (219+PAGE_OFFSET)

#define PAGE_CHS_MODULE_CALIBRATION             (220+PAGE_OFFSET)
#define PAGE_CHS_MODULE_CALIBRATION_DARK        (221+PAGE_OFFSET)
#define PAGE_ENG_MODULE_CALIBRATION             (222+PAGE_OFFSET) 
#define PAGE_ENG_MODULE_CALIBRATION_DARK        (223+PAGE_OFFSET) 

#define PAGE_CHS_LEVEING_TIP									  (224+PAGE_OFFSET) 
#define PAGE_ENG_LEVEING_TIP									  (225+PAGE_OFFSET)

#define PAGE_CHS_LEVEING_FAILED									(226+PAGE_OFFSET) 
#define PAGE_ENG_LEVEING_FAILED									(227+PAGE_OFFSET) 

#define PAGE_CHS_SPEED_SILENT								(230+PAGE_OFFSET)
#define PAGE_CHS_SPEED_STANDARD								(231+PAGE_OFFSET)
#define PAGE_CHS_SPEED_SPORT								(232+PAGE_OFFSET)

#define PAGE_ENG_SPEED_SILENT								(233+PAGE_OFFSET)
#define PAGE_ENG_SPEED_STANDARD								(234+PAGE_OFFSET)
#define PAGE_ENG_SPEED_SPORT								(235+PAGE_OFFSET)

#define PAGE_CHS_RESET										(236+PAGE_OFFSET)
#define PAGE_ENG_RESET										(237+PAGE_OFFSET)

#define PAGE_CHS_FAN_ON										(238+PAGE_OFFSET)
#define PAGE_CHS_FAN_ON_DARK								(239+PAGE_OFFSET)
#define PAGE_CHS_FAN_OFF									(240+PAGE_OFFSET)
#define PAGE_CHS_FAN_ON_DARK								(241+PAGE_OFFSET)
...
#define TXT_ABOUT_UI_VERSION     0x2730
...
#define TXT_LEVEING_HEATING      0x2800
#define TXT_LEVEING_CLEAN      	 0x2850
#define TXT_LEVEING_PROBE        0x2900

#define TXT_OK                   "OK"
#define TXT_RUN                  "..."
#define TXT_WAIT                 "Wait"
#define TXT_RUN_1									"."
#define TXT_RUN_2									".."
#define TXT_RUN_3									"..."
...
namespace Anycubic {
  ...
  class DgusTFT {
    ...
    static uint8_t          ready;
		static float            move_dis;
		static uint8_t          print_speed_mode;
		static float            temp_zoffset;
  	static bool             fan_change;
	static bool             preheat_state;
	static bool             have_heated_task;
	static bool             nozzle_heated_state;
	static bool             bed_heated_state;
	static int16_t          temp_nozzle_Target;
	static int16_t          temp_bed_Target;
	static uint8_t          heated_count;
	static bool             is_bedHeated;
    ...
    public:
      ...
      static uint32_t         page_index_now;
			...
			void clean_heated_state();
			void Heater_handle();
			void SetNozzleOrBedTarget();
			void SetPopUpIndex(uint8_t index) { pop_up_index = index;}
      void Startup();
      void ParamInit();
      void IdleLoop();
...
//      static void page178_to_181_190_to_193_handle(void);
      ...
      static void page206_handle(void);
			static void page216_to_219_handle(void);
			static void page220_to_223_handle(void);
			static void page224_to_225_handle(void);
			static void page226_to_227_handle(void);
			static void page228_to_230_handle(void);
			static void page236_to_237_handle(void);
			static void page_238_to_241_handle(void);
