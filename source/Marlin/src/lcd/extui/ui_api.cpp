...
namespace ExtUI {
  ...
  void setFeedrate_percent(const float value) {
    feedrate_percentage = constrain(value, 5, 500);
  }
  ...
  bool isPrintingFromMedia() {
      ...
      flags.was_sd_printing = card.isFileOpen() || (flags.was_sd_printing && commandsInQueue());
			//SERIAL_ECHOLNPAIR("flags.was_sd_printing: ", flags.was_sd_printing);
			//SERIAL_ECHOLNPAIR("commandsInQueue(): ", commandsInQueue);
