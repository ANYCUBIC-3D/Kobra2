...
namespace ExtUI {
  ...
  void onPrintFinished() 	{Dgus.PrintFinished();}
...
//    static_assert(sizeof(Dgus.lcd_info) <= ExtUI::eeprom_data_size);
  ...
  void onSteppersDisabled() {	set_all_unhomed(); recovery.file.writeln_P("onSteppersDisabled");}
  void onSteppersEnabled()  {}
	void onSetPopUpIndex(uint8_t index) { Dgus.SetPopUpIndex(index);}
}
