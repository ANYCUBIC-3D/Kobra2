...
public:
  ...
  static char* longest_filename() { return longFilename[0] ? longFilename : filename; }
    ...
    static void getLongPath(char *pathLong, char * const pathShort);
  #endif
  ...
  // TODO: rename to diskIODriver()
    ...
    static DiskIODriver_SDIO& diskIODriver() { return sd2card; }
    #else
    static DiskIODriver_SPI_SD& diskIODriver() { return sd2card; }
    #endif
...
private:
  ...
  #if ENABLED(SDIO_SUPPORT)
  static DiskIODriver_SDIO sd2card;
  #else
  static DiskIODriver_SPI_SD sd2card;
  #endif
