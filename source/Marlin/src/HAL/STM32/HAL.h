...
inline bool isr_state() { return true; }
inline void isr_on()  { sei(); }
inline void isr_off() { cli(); }
 ...
 */
inline void set_pwm_frequency(const pin_t pin, int f_desired){
}
 ...
 */inline void set_pwm_duty(const pin_t pin, const uint16_t v, const uint16_t v_size, const bool invert){
