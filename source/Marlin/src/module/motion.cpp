...
xyze_pos_t temp_position = { 0, 0, 0 };
/**
...
void do_blocking_move_to(NUM_AXIS_ARGS(const_float_t), const_feedRate_t fr_mm_s/*=0.0f*/) {
  ...
  SECONDARY_AXIS_CODE(
    ...
    if (destination.z > z) { destination.z = z; prepare_internal_fast_move_to_destination(z_feedrate); }
      ...
      if (current_position.z < z) { current_position.z = z; 
      line_to_current_position(z_feedrate); 
        //SERIAL_ECHOPGM("raise z_feedrate:",z_feedrate);
      }
    #endif
    ...
    line_to_current_position(xy_feedrate);
      ...
      if (current_position.z > z) { current_position.z = z; 
		  line_to_current_position(z_feedrate); 
        //SERIAL_ECHOPGM("lower z_feedrate:",z_feedrate);
      }
    #endif
