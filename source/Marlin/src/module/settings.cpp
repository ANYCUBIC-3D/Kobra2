...
typedef struct SettingsDataStruct {
  ...
  //
    ...
    bool buzzer_enabled;
		...
		xyz_pos_t module_position;
	#endif

	#if ENABLED(SD_CARD_LOG)
		bool sdcard_enabled;                           // M2005 S
	#endif
} SettingsData;
  ...
  bool MarlinSettings::save() {
    ...
    //
      ...
      EEPROM_WRITE(ui.buzzer_enabled);
			...
			//EEPROM_WRITE(autoProbe.calibration_positon.y);
			//EEPROM_WRITE(autoProbe.calibration_positon.z);
		#endif
    ...
    if (strncmp(version, stored_ver, 3) != 0) {
      ...
      //
        ...
        EEPROM_READ(ui.buzzer_enabled);
						...
						//EEPROM_READ(autoProbe.calibration_positon.y);
						//EEPROM_WRITE(autoProbe.calibration_positon.z);
			#endif
